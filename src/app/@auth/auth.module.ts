...
import {
  ...
  NbCheckboxModule,
  NbInputModule,
  NbButtonModule, NbSelectModule, NbTooltipModule, NbSpinnerModule, NbStepperModule
} from '@nebular/theme';
import { AuthRoutingModule } from './auth-routing.module';
import { ComponentsModule } from '../@components/components.module';
import { authOptions } from './auth.settings';
import { authSettings } from './access.settings';
import { NgxauthenticateComponent } from './components/ngxauthenticate/ngxauthenticate.component';
...
@NgModule({
  declarations: [...PIPES, ...COMPONENTS, NgxauthenticateComponent, PaymentComponent],
  imports: [
    AuthRoutingModule,
    ReactiveFormsModule,
    CommonModule,
