...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  constructor(private sidebarService: NbSidebarService,
    ...
    if (user && user.userType === ROLES.ADMIN) {
      this.userInfo.currentAdminUser$.subscribe(u => {
        this.user = u;
      });
    }
    else if (user && user.userType === ROLES.BUSINESS) {
      this.userInfo.currentUser$.subscribe(u => {
        this.user = u;
      });
    }
  }
  ...
  ngOnDestroy() {
    ...
    // this.userInfo.currentAdminUser$.unsubscribe();
  }
  ...
  changeTheme(c) {
    ...
    this.themeService.changeTheme(c);
  }
