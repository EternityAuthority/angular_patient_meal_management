...
@Component({
  ...
  template: `
      <div class="warning">
          ...
          <span class="caption status-danger" *ngIf="showPasswordMatchError">{{label}} should be same</span>
          <span class="caption status-danger" *ngIf="showEmailMatchError">{{label}} and Email should be same</span>
      </div>
  `,
  providers: [
    {
